...
[Hello Rails](https://github.com/SabiMantock/hello-rails-back-end)
...
```sh
git clone git@github.com:SabiMantock/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/SabiMantock/hello-react-front-end/issues).
